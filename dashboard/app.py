...
.kind-banner strong{display:block}.kind-banner p{margin:.3rem 0}.kind-setup[hidden]{display:none}.kind-command-row{align-items:stretch;display:flex;gap:.5rem;margin-top:.7rem}.kind-command{background:#fff;border:1px solid #d4a653;border-radius:8px;color:#503000;display:block;flex:1;font:650 .78rem/1.45 ui-monospace,SFMono-Regular,Menlo,monospace;overflow-wrap:anywhere;padding:.65rem .75rem;white-space:pre-wrap}.copy-button{background:#7c4b00;border:0;border-radius:8px;color:#fff;cursor:pointer;font:750 .82rem system-ui;padding:.55rem .8rem}.copy-button:hover{background:#593600}.copy-button:focus-visible{outline:3px solid #e1ad51;outline-offset:2px}.copy-status{display:block;font-size:.78rem;min-height:1.2em;margin-top:.3rem}.kind-banner.ready .kind-command-row,.kind-banner.ready .copy-status{display:none}
  ...
  <section class="panel bundle-panel" aria-labelledby="bundles-title">
    ...
    <div id="kind-banner" class="kind-banner" role="status">
      ...
      <div id="kind-setup" class="kind-setup">
        <p>Diese Befehle in Windows PowerShell einfügen (Git wird nicht benötigt):</p>
        <div class="kind-command-row">
          <code id="kubernetes-command" class="kind-command">docker compose down
...
async function copyKubernetesCommand(){
  ...
  try{
    ...
    status.textContent='PowerShell-Befehle kopiert. Jetzt im Terminal einfügen.';
  }catch(error){
